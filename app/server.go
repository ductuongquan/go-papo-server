...
import (
	...
	"bitbucket.org/enesyteam/papo-server/audit"
	"bitbucket.org/enesyteam/papo-server/config"
	...
	"bitbucket.org/enesyteam/papo-server/services/awsmeter"
	"bitbucket.org/enesyteam/papo-server/services/cache"
	"bitbucket.org/enesyteam/papo-server/services/filesstore"
	"bitbucket.org/enesyteam/papo-server/services/httpservice"
	"bitbucket.org/enesyteam/papo-server/services/imageproxy"
	"bitbucket.org/enesyteam/papo-server/services/mailservice"
	"bitbucket.org/enesyteam/papo-server/services/searchengine"
	"bitbucket.org/enesyteam/papo-server/services/searchengine/bleveengine"
	"bitbucket.org/enesyteam/papo-server/services/telemetry"
	"bitbucket.org/enesyteam/papo-server/services/timezones"
	"bitbucket.org/enesyteam/papo-server/services/tracing"
	"bitbucket.org/enesyteam/papo-server/services/upgrader"
	"bitbucket.org/enesyteam/papo-server/store"
	"bitbucket.org/enesyteam/papo-server/store/localcachelayer"
	"bitbucket.org/enesyteam/papo-server/store/retrylayer"
	"bitbucket.org/enesyteam/papo-server/store/searchlayer"
	"bitbucket.org/enesyteam/papo-server/store/sqlstore"
	"bitbucket.org/enesyteam/papo-server/store/timerlayer"
...
func NewServer(options ...Option) (*Server, error) {
	...
	s.seenPendingPostIdsCache = s.CacheProvider.NewCache(&cache.CacheOptions{
		Size: PENDING_MESSAGE_IDS_CACHE_SIZE,
	})
	...
	// TODO: Check this if enabled - perform initial product notices fetch
