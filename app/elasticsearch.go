...
//	//fmt.Println("cfg", cfg)
//	//fmt.Println("*cfg.ElasticsearchSettings.Password", *cfg.ElasticsearchSettings.Password)
...
//	}
//
//	fmt.Println("a.License().Features.Elasticsearch", a.License().Features.Elasticsearch)
//
//	esI := a.Elasticsearch
//	if esI == nil {
