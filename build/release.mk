...
package:
	...
	cp -RL $(BUILD_WEBAPP_DIR)/public/* $(DIST_PATH)/client
...
ifeq ($(BUILDER_GOOS_GOARCH),"darwin_amd64")
	...
	cp $(GOPATH)/bin/cmd $(DIST_PATH)/bin # from cross-compiled bin dir
endif
	@# Package
...
ifeq ($(BUILDER_GOOS_GOARCH),"windows_amd64")
	...
	cp $(GOPATH)/bin/cmd.exe $(DIST_PATH)/bin # from cross-compiled bin dir
endif
	@# Package
