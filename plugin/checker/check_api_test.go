...
func TestCheckAPIVersionComments(t *testing.T) {
	testCases := []struct {
		...
		{
			name:    "valid comments",
			pkgPath: "bitbucket.org/enesyteam/papo-server/plugin/checker/internal/test/valid",
			err:     "",
		},
		{
			name:    "invalid comments",
			pkgPath: "bitbucket.org/enesyteam/papo-server/plugin/checker/internal/test/invalid",
			expected: result{
		...
		},
		{
			...
			pkgPath: "bitbucket.org/enesyteam/papo-server/plugin/checker/internal/test/missing",
			err:     "could not find API interface",
		},
		{
			name:    "non-existent package path",
			pkgPath: "bitbucket.org/enesyteam/papo-server/plugin/checker/internal/test/does_not_exist",
			err:     "could not find API interface",
		},
	}
