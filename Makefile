...
GO=go
DELVE=dlv
LDFLAGS += -X "bitbucket.org/enesyteam/papo-server/model.BuildNumber=$(BUILD_NUMBER)"
LDFLAGS += -X "bitbucket.org/enesyteam/papo-server/model.BuildDate=$(BUILD_DATE)"
LDFLAGS += -X "bitbucket.org/enesyteam/papo-server/model.BuildHash=$(BUILD_HASH)"
LDFLAGS += -X "bitbucket.org/enesyteam/papo-server/model.BuildHashEnterprise=$(BUILD_HASH_ENTERPRISE)"
LDFLAGS += -X "bitbucket.org/enesyteam/papo-server/model.BuildEnterpriseReady=$(BUILD_ENTERPRISE_READY)"
...
debug-server: start-docker ## Compile and start server using delve.
	...
	$(DELVE) debug $(PLATFORM_FILES) --build-flags="-ldflags '\
		-X bitbucket.org/enesyteam/papo-server/model.BuildNumber=$(BUILD_NUMBER)\
		-X \"bitbucket.org/enesyteam/papo-server/model.BuildDate=$(BUILD_DATE)\"\
		-X bitbucket.org/enesyteam/papo-server/model.BuildHash=$(BUILD_HASH)\
		-X bitbucket.org/enesyteam/papo-server/model.BuildHashEnterprise=$(BUILD_HASH_ENTERPRISE)\
		-X bitbucket.org/enesyteam/papo-server/model.BuildEnterpriseReady=$(BUILD_ENTERPRISE_READY)'"
