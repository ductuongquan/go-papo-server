...
func (h Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if h.IsStatic {
		...
		// TODO: Set content security policy. This is also specified in the root.html of the webapp in a meta tag.
	...
	if len(token) != 0 {
		...
		//fmt.Println("csrfCheckPassed", csrfCheckPassed)
		//fmt.Println("csrfHeader", r.Header.Get(model.HEADER_CSRF_TOKEN))
