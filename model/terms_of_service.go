...
func (t *TermsOfService) IsValid() *AppError {
	...
	if utf8.RuneCountInString(t.Text) > /*POST_MESSAGE_MAX_RUNES_V2*/20000 {
...
func InvalidTermsOfServiceError(fieldName string, termsOfServiceId string) *AppError {
	...
	return NewAppError("TermsOfServiceStore.IsValid", id, map[string]interface{}{"MaxLength": 20000}, details, http.StatusBadRequest)
}
